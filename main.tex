...
\node[anchor=west,visible on=<5->] at (2.5,1.5) {
    $\textcolor{blue}{P(O|M_1)} = \frac{\begin{tikzpicture}[baseline=2pt]
    ...
    \begin{tikzpicture}[baseline=2pt]
        \draw[thick,fill=purple!20] (0,0) rectangle (0.6,0.6);
    \end{tikzpicture}} = \dfrac{|O\cap M_1|}{|M_1|}$};

\node[anchor=west,visible on=<6->] at (2.5,0) {
    $\textcolor{blue}{P(O|M_2)} = \frac{\begin{tikzpicture}[baseline=2pt]
...
\node[anchor=west,visible on=<7->] at (2.5,-1.5) {
    $\textcolor{red}{P(M_1|O)} = \textcolor{blue}{P(O|M_1)}\dfrac{P(M_1)}{P(O)} = \frac{\begin{tikzpicture}[baseline=2pt]
        \draw[thick,fill=purple!20] (0,0) rectangle (0.6,0.6);
        \fill[pattern=north east lines, pattern color=green] (0,0) rectangle (0.6,0.6);
    \end{tikzpicture}}{
    \begin{tikzpicture}[baseline=2pt]
        \draw[thick,fill=purple!20] (0,0) rectangle (0.6,0.6);
    \end{tikzpicture}} \frac{\begin{tikzpicture}[baseline=2pt]
        \draw[thick,fill=purple!20] (0,0) rectangle (0.6,0.6);
    \end{tikzpicture}}{
    \begin{tikzpicture}[baseline=2pt]
...
\node[anchor=west,visible on=<8->] at (2.5,-3) {
    $\textcolor{red}{P(M_2|O)} = \textcolor{blue}{P(O|M_2)}\dfrac{P(M_2)}{P(O)} = \frac{\begin{tikzpicture}[baseline=2pt]
        \draw[thick,fill=yellow!20] (0,0) rectangle (0.6,0.6);
        \fill[pattern=north east lines, pattern color=green] (0,0) rectangle (0.6,0.6);
    \end{tikzpicture}}{
    \begin{tikzpicture}[baseline=2pt]
...
\foreach \x/\y in {-1.5/1.2, -1.2/0.8, -0.8/-1.5, -1.3/-0.5, -0.7/0.5} {
    \draw[fill=purple,draw=none,visible on=<9->] (\x,\y) circle (0.5mm);
}

% Add random nodes within M2 (in yellow)
\foreach \x/\y in {0.5/1.2, 1.2/0.8, 0.8/1.5, 1.3/-0.5, 0.7/0.5} {
    \draw[fill=yellow!20!orange,draw=none,visible on=<10->] (\x,\y) circle (0.5mm);
}
\end{tikzpicture}
\end{frame}
